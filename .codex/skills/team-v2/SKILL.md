---
name: "team-v2"
description: "Multi-agent team skill v2.2.0. Architect orchestrates all phases directly at every tier. Dedicated Fixer agent repairs failures at Tier 2-3. Memory Curator handles wrap-up at Tier 3. No Dispatcher — Architect is the sole state writer and phase controller."
metadata:
  version: 2.2.0
...
|---------|-------------|
| `/team-v2` | Describe task → recommend tier → approve → spawn team |
| `/team-v2 tier-N` | Directly spawn a team at the specified tier (1, 2, or 3) |
| `/team-v2 evaluate-tier` | Analyze task and recommend a tier without spawning |
| `/team-v2 scale-up` | Add teammates mid-execution (e.g., Tier 1 → Tier 2) |
| `/team-v2 scale-down` | Remove teammates mid-execution (e.g., Tier 3 → Tier 2) |
| `/team-v2 status` | Show current team state (tier, phase, iteration, teammates, costs) |
| `/team-v2 abort` | Gracefully shut down all teammates and preserve work |
